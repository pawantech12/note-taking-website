...
const About = () => {
  return (
    <>
      <div className="about flex justify-around items-center h-screen">
        <div className="content w-[40%]">
          <h1 className="text-6xl font-bold leading-tight">About</h1>
          <p className="text-xl">
      ...
      <div className="mt-9">
        ...
        <div className="flex justify-center mt-11">
          <div className="bg-white rounded-xl w-96 shadow-md overflow-hidden text-center flex flex-col gap-1 items-center py-4 px-5">
